...
public class BookOfDead extends Item {
	...
	private static final String TXT_PREVENTING2 = "Darkness blurs your eyes as you try to read! You will need to find the exit...";
	...
	public void execute(Hero hero, String action) {
		...
		if (action == AC_PORT) {
			...
			if (Dungeon.bossLevel()) {
				hero.spend(BookOfDead.TIME_TO_USE);
